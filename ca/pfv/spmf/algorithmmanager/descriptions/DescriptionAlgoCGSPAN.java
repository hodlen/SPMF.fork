...
import ca.pfv.spmf.algorithms.graph_mining.tkg.AlgoCGSPAN;

/**
 * This class describes the CGSPAN algorithm parameters. It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoCGSPAN
 * @author Zevin Shaul et al.
 */
public class DescriptionAlgoCGSPAN extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoCGSPAN(){
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException, ClassNotFoundException {
		...
		// Apply the algorithm 
		AlgoCGSPAN algo = new AlgoCGSPAN();
